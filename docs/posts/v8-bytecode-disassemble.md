...
因此本文将以文章发布时它的最新版本 `9.9.23-41857 (64位)` 作为教具，开始我们的分析。
...
{
    return napi_module_register(&unk_180EB96E0);
}
```

很明显，这个结构体 `unk_180EB96E0` 就是 `napi_module`。
...
```c title="sub_180017350" linenums="1"
__int64 __fastcall Init(__int64 env, __int64 exports)
{
    ...
    v5 = env;
    v4 = Init0;                                   // sub_18001AEC0
    v6 = exports;
    v3[0] = &v4;
    v3[1] = &v5;
    v3[2] = &v6;
    return TryInit((__int64)v3);                  // sub_1800179E0
}
```

我们继续查看 `TryInit`(`sub_1800179E0`) 的伪代码：

```c title="sub_1800179E0" linenums="1" hl_lines="16"
...
```c title="sub_18001AEC0" linenums="1" hl_lines="13 35"
_OWORD *__fastcall Init0(_OWORD *a1, __int64 a2, __int64 *a3)
{
  ...
  if ( v6 )
  {
    ...
    v8 = is_v8_bytecode_debug;                  // byte_184ECF9F0
    if ( !v7 )
      v8 = 1;
  ...
  {
    v9[1] = 0;
    *v9 = func_exports_load_data;               // sub_18001B0B0
  }
  else
  {
    v9 = 0;
  }
  // sub_18001DB80 == func_exports_load
  if ( (unsigned int)napi_create_function(a2, 0, -1, func_exports_load, v9, &load_func_value)
    || (unsigned int)napi_add_finalizer(a2, load_func_value, v9, &sub_180017390, 0, 0) )
  {
    j_j_free(v9);
...
__int64 __fastcall func_exports_load(__int64 env, __int64 info)
{
  ...
  v3[0] = &v4;
  v3[1] = &v5;
  return func_exports_load0(v3);                // sub_180017A20
}
```

```c title="sub_180017A20"
...
const resourcesPath = process.resourcesPath;  // <安装路径>\versions\9.9.23-41857\resources
...
```eiffel hl_lines="5-8"
[02:37:05.260 INF] [preload] succeeded. <PATH_APP>\versions\9.9.23-41857\resources\app\major.node
[02:37:05.277 INF] [preload] succeeded. <PATH_APP>\versions\9.9.23-41857\resources\app\wrapper.node
[02:37:05.309 INF] resourcesPath: <PATH_APP>\versions\9.9.23-41857\resources
[02:37:05.326 INF] [preload] register done. major.node
[02:37:05.326 INF] major ... v8.31.11
[02:37:05.326 INF] file path: <PATH_APP>\versions\9.9.23-41857\resources\app\app_launcher\
load internal done, file_name: <PATH_APP>\versions\9.9.23-41857\resources\app\app_launcher\index.js
[02:37:05.655 INF] dumper <PATH_APP>\versions\9.9.23-41857\resources\app\app_launcher\index.js <Buffer 7a 05 de c0 03 58 f2 72 cc 0b 00 00 09 f3 4c 5e 7b e3 bf 40 20 0d 00 00 00 00 00 00 00 00 00 00 01 30 54 1d 03 30 07 b4 1e 60 0c 00 00 00 01 08 07 d9 ... 3342 more bytes>
[02:37:05.656 INF] major ... v8.31.11
[02:37:05.656 INF] file path: <PATH_APP>\versions\9.9.23-41857\resources\app\app_launcher\
load internal done, file_name: <PATH_APP>\versions\9.9.23-41857\resources\app\app_launcher\launcher.js
[02:37:05.657 INF] dumper <PATH_APP>\versions\9.9.23-41857\resources\app\app_launcher\launcher.js <Buffer 7a 05 de c0 03 58 f2 72 57 a7 00 00 09 f3 4c 5e 7b e3 bf 40 a8 ca 00 00 00 00 00 00 00 00 00 00 01 30 54 1d 03 30 07 b4 1e 60 0c 00 00 00 01 08 07 d9 ... 51862 more bytes>
[02:37:05.676 INF] major ... v8.31.11
[02:37:05.676 INF] file path: <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\
load internal done, file_name: <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\background.js
[02:37:05.677 INF] dumper <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\background.js <Buffer 7a 05 de c0 03 58 f2 72 64 b4 01 00 09 f3 4c 5e 7b e3 bf 40 18 da 03 00 00 00 00 00 00 00 00 00 01 30 54 1d 03 30 07 b4 1e 60 0c 00 00 00 01 08 07 d9 ... 252422 more bytes>
# ...
[02:37:05.678 INF] major ... v8.31.11
[02:37:05.679 INF] file path: <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\
load internal done, file_name: <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\416.background.js
[02:37:05.679 INF] dumper <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\416.background.js <Buffer 7a 05 de c0 03 58 f2 72 74 26 00 00 09 f3 4c 5e 7b e3 bf 40 70 70 00 00 00 00 00 00 00 00 00 00 01 30 54 1d 03 30 07 b4 1e 60 0c 00 00 00 01 08 07 d9 ... 28766 more bytes>
[02:37:05.679 INF] [preload] register done. wrapper.node
# ...
[02:37:10.600 INF] [renderer] dumper <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\renderer\50271.js [object Uint8Array]
[02:37:10.602 INF] [renderer] dumper <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\renderer\app.js [object Uint8Array]
[02:37:10.651 INF] [renderer] dumper <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\renderer\service-widgets-Profile.js [object Uint8Array] 
[02:37:10.651 INF] [renderer] dumper <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\renderer\commonNodeModule-???????-??-container.js [object Uint8Array]
[renderer] dumper <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\renderer\commonNodeModule-base64-js.js [object Uint8Array]
[renderer] dumper <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\renderer\commonNodeModule-uuid.js [object Uint8Array]
[renderer] dumper <PATH_APP>\versions\9.9.23-41857\resources\app\application.asar\renderer\commonNodeModule-js-md5.js [object Uint8Array]
# ...
```
